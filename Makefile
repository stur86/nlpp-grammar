LANGUAGE_NAME := tree-sitter-nlpp
HOMEPAGE_URL := https://github.com/stur86/nlpp-grammar
VERSION := 0.1.0
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/nlpp
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/nlpp
